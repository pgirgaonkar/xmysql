...
program
  ...
  .option("-z, --useDateStrings", "return date as string in pure date format")
  .parse(process.argv);
...
exports.handle = program => {
  ...
  program.dateStrings = program.useDateStrings || false;

  console.log ("\n\n\t  Input args - program.dateStrings = " + program.dateStrings)
